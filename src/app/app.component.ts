...
import { faPhone, faSchool, faBook, faNotEqual, IconDefinition, faAddressCard, faBicycle, faDraftingCompass } from "@fortawesome/free-solid-svg-icons";
...
export class AppComponent {
  ...
  ngAfterViewInit() {
    ...
    this.navbarConfig.push(
      { navName: "Kontakt",      offsetTarget: () => 0, elementTarget: this.cmpWelcome.elRef.nativeElement, icon: faAddressCard },
      ...
      { navName: "Projekty",     offsetTarget: projectsOffsetTarget, elementTarget: this.cmpProjects.elRef.nativeElement, icon: faDraftingCompass },
      { navName: "Hobby",        offsetTarget: hobbyOffsetTarget, elementTarget: this.cmpHobby.elRef.nativeElement, icon: faBicycle }
    );
